                        ...
                        <article>
                            ...
                            <div class="wrapper">
                                ...
                                <div class="avatar-upload">
                                    <form action="../php/upload_group_avatar.php" method="POST"
                                        enctype="multipart/form-data">
                                        <div class="avatar-edit">
                                            <input type="file" id="imageUpload" name="group_pic"
                                                accept=".png, .jpg, .jpeg" />
                                            <label for="imageUpload"></label>
                                        </div>
                                        <div class="avatar-preview">
                                            <div id="imagePreview"
                                                style="background-image:<?php echo " url(../group_pic/group_pic_$groupname.png)"; ?>;">
                                            </div>
                                        </div>
