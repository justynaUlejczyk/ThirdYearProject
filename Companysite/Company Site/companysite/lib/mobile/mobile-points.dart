...
class mobile_5points extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double cardWidth = MediaQuery.of(context).size.width < 1000 ? 400 : 400;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Column(
            children: [
              const MyCustomText(text: 'Innovative Solutions', fontSize: 24),
              const SizedBox(
                height: 20,
              ),
              MyCustomText(
          ...
          Column(
            children: [
              const MyCustomText(text: 'Client-Centric Approach', fontSize: 24),
              const SizedBox(
                height: 20,
              ),
              MyCustomText(
          ...
          Column(
            children: [
              const MyCustomText(text: 'Tailored Development', fontSize: 24),
              const SizedBox(
                height: 20,
              ),
              MyCustomText(
